...
const generateRandomData = async () => {
  try {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      console.log(`User${i + 1} -> Email: user${i + 1}@example.com, Password: ${plainPassword}`); // Print plain password
    ...
    console.log(`Admin -> Email: admintitipin@gmail.com, Password: ${adminPassword}`); // Print plain password
