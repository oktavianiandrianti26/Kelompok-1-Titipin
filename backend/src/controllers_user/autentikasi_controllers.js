...
const editProfile = async (req, res) => {
  try {
    ...
    return ResponseAPI.success(
      res,
      "Foto profil berhasil diperbarui! harap refresh browser Anda",
      200
    );
  } catch (err) {
...
const getUsers = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Gagal mengambil data pengguna", error: err });
  }
};
...
const uploadProfileImage = async (req, res) => {
  try {
    ...
    res.status(200).json({
      message: "Foto profil berhasil diperbarui! harap refresh browser Anda",
    ...
    res
      .status(500)
      .json({ message: "Gagal mengunggah foto", error: error.message });
  }
};
